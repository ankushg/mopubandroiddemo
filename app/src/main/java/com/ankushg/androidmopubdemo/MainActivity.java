...
public class MainActivity extends ActionBarActivity {
    ...
    public void showInterstitial(View v){
        MainActivity.this.startActivity(new Intent(MainActivity.this, InterstitialActivity.class));
    }
    ...
    public void showNative(View v){
        MainActivity.this.startActivity(new Intent(MainActivity.this, NativeActivity.class));
    }
}
